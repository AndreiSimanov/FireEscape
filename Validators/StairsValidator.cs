...
public class StairsValidator : AbstractValidator<Stairs>
{
    public StairsValidator()
    {
        ...
        When(stairs => stairs.StairsType is StairsTypeEnum.P1_1 or StairsTypeEnum.P1_2, () =>
        {
            RuleFor(stairs => stairs.SupportBeams!.SupportBeamsCount).GreaterThan(0).WithMessage(AppResources.SupportBeamsPairsCountHint);
            RuleFor(stairs => stairs.SupportBeams!.WallDistance.Value).GreaterThan(0).WithMessage(AppResources.WallDistanceHint);
        ...
        When(stairs => stairs.StairsType is StairsTypeEnum.P1_1 or StairsTypeEnum.P1_2, () => // check stairs elements for P1 & P1-2
        {
            When(stairs => stairs.StairsType is StairsTypeEnum.P1_2, () => // check is fence exists for P1-2
            {
                RuleFor(stairs => stairs.StairsElements.Where(stairsElement => stairsElement.StairsElementType == typeof(FenceP1)).ToArray()).
                    Must(stairsElements => stairsElements.Length == 1).WithMessage(AppResources.FenceAbsentHint);
            });

            RuleForEach(stairs => stairs.StairsElements).
                Where(stairsElement => stairsElement.StairsElementType == typeof(PlatformP1)).
            ...
            RuleForEach(stairs => stairs.StairsElements).
                Where(stairsElement => stairsElement.StairsElementType == typeof(StepsP1)).
        ...
        When(stairs => stairs.StairsType is StairsTypeEnum.P2, () => // check stairs elements for P2
        {
            ...
            RuleForEach(stairs => stairs.StairsElements).
                Where(stairsElement => stairsElement.StairsElementType == typeof(PlatformP2)).
            ...
            RuleForEach(stairs => stairs.StairsElements).
                Where(stairsElement => stairsElement.StairsElementType == typeof(StairwayP2)).
            ...
            RuleForEach(stairs => stairs.StairsElements).
                Where(stairsElement => stairsElement.StairsElementType == typeof(StepsP2)).
            ...
            RuleForEach(stairs => stairs.StairsElements).
                Where(stairsElement => stairsElement.StairsElementType == typeof(FenceP2)).
